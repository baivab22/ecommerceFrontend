...
//           paymentReferenceId: paymentReferenceId, // Send payment reference to API
...
//   }, [isInsideValley, isPhonePaySelected, paymentReferenceId])
...
//                     gap: '12px',
//                     padding: '14px',
//                     backgroundColor: index === 3 ? '#fef7cd' : 'white',
//                     borderRadius: '10px',
//                     border: index === 3 ? '2px solid #f59e0b' : '1px solid #e2e8f0',
...
//                       height: '26px',
//                       borderRadius: '50%',
//                       backgroundColor: index === 3 ? '#f59e0b' : '#22c55e',
//                       color: 'white',
//                       display: 'flex',
//                       alignItems: 'center',
//                       justifyContent: 'center',
...
//             >
//               <div style={{ display: 'flex', flexDirection: 'row', gap: '8px', flex: 1, width: '100%' }}>
...
//               <p style={{ margin: 0, fontSize: '16px', fontWeight: '600', color: '#1e293b' }}>{getNprPrice(shippingRate)}</p>
//             </div>
//           )}
...
// // Gift Box Images - using your provided image paths
// const GIFT_BOX_IMAGES = [
//   { id: 1, src: 'image1.jpg', alt: 'Gift Box Design 1' },
//   { id: 2, src: 'image2.jpg', alt: 'Gift Box Design 2' }
// ] as const
...
//   const [selectedGiftBoxImage, setSelectedGiftBoxImage] = useState<string | null>(null)
...
//   const handleGiftBoxChange = useCallback((include: boolean) => {
//     setIncludeGiftBox(include)
//     // If user deselects gift box, also clear the selected image
//     if (!include) {
//       setSelectedGiftBoxImage(null)
//     } else if (include && !selectedGiftBoxImage) {
//       // If selecting gift box and no image is selected, select the first one
//       setSelectedGiftBoxImage(GIFT_BOX_IMAGES[0].src)
//     }
//   }, [selectedGiftBoxImage])

//   const handleGiftBoxImageSelect = useCallback((imageSrc: string) => {
//     setSelectedGiftBoxImage(imageSrc)
//   }, [])
...
//     // Gift box validation - if gift box is selected, an image must be chosen
//     if (includeGiftBox && !selectedGiftBoxImage) {
//       errors.push('Please select a gift box design')
//     }
...
//           giftBoxImage: selectedGiftBoxImage,
//           isHomeDelivery: selectedDeliveryTypeOption?.value === 'home',
//           totalAmount: total,
//           ...({
//             latitude: locationCoordinates?.latitude || location.lat,
...
//                 color: '#b45309'
//               }}>
//                 Make your order special with premium gift packaging
//               </p>
//             </div>
//           </div>
...
//               width: '60px',
//               height: '30px',
//               backgroundColor: includeGiftBox ? '#10b981' : '#e5e7eb',
//               borderRadius: '15px',
//               position: 'relative',
//               cursor: 'pointer',
//               transition: 'all 0.3s ease'
//             }}
//             onClick={() => handleGiftBoxChange(!includeGiftBox)}
//             >
//               <div style={{
//                 position: 'absolute',
//                 top: '3px',
//                 left: includeGiftBox ? '33px' : '3px',
//                 width: '24px',
//                 height: '24px',
//                 backgroundColor: 'white',
//                 borderRadius: '50%',
...
//                       gap: '8px',
//                       padding: '12px',
//                       backgroundColor: selectedGiftBoxImage === image.src ? '#f0f9ff' : 'white',
//                       borderRadius: '10px',
//                       border: `2px solid ${selectedGiftBoxImage === image.src ? '#3b82f6' : '#e5e7eb'}`,
//                       cursor: 'pointer',
//                       transition: 'all 0.2s ease'
//                     }}
//                     onClick={() => handleGiftBoxImageSelect(image.src)}
//                   >
//                     <div style={{
//                       width: '100%',
//                       height: '120px',
...
//                         }}
//                         onError={(e) => {
//                           console.error('Gift box image failed to load:', image.src);
//                           e.currentTarget.style.display = 'none';
...
//                       fontSize: '13px',
//                       fontWeight: '600',
//                       color: selectedGiftBoxImage === image.src ? '#1d4ed8' : '#6b7280'
//                     }}>
//                       Design {image.id}
//                     </div>
//                     {selectedGiftBoxImage === image.src && (
//                       <div style={{
//                         padding: '4px 8px',
//                         backgroundColor: '#10b981',
//                         color: 'white',
...
//                   textAlign: 'center'
//                 }}>
//                   ⚠️ Please select a gift box design
//                 </p>
//               )}
//             </div>
...
//                 fontWeight: '500'
//               }}>
//                 Gift packaging includes premium box, ribbon, and greeting card
//               </p>
//             </div>
//           </>
//         )}
...
//           {includeGiftBox && (
//             <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
//               <p style={{ margin: 0, fontSize: '16px', color: '#475569' }}>Gift Box Packaging</p>
...
//                 lineHeight: '1.4'
//               }}>
//                 Premium box with elegant ribbon and greeting card included
//               </p>
//             </div>
//           </div> */}
//         </div>
...
//           {/* Compact Gift Box Section (Added at the end) */}
//           <GiftBoxSection />
