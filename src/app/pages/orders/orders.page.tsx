...
//   const [modalTrackingLoading, setModalTrackingLoading] =
//     useState<boolean>(false)
...
//             }}
//             disabled={
//               activeData.filter((item) => Object.keys(item).length !== 0)
//                 .length === 0
//             }
//           />
//         </HStack>
...
//                         : '1px solid #ccc',
//                     backgroundColor:
//                       dateFilterType === 'all' ? '#e3f2fd' : 'white',
//                     cursor: 'pointer',
//                     fontSize: '12px',
...
//                         : '1px solid #ccc',
//                     backgroundColor:
//                       dateFilterType === 'last1hour' ? '#e3f2fd' : 'white',
//                     cursor: 'pointer',
//                     fontSize: '12px',
//                     fontWeight:
//                       dateFilterType === 'last1hour' ? 'bold' : 'normal'
//                   }}
//                 >
//                   Last 1 Hour
//                 </button>
...
//                         : '1px solid #ccc',
//                     backgroundColor:
//                       dateFilterType === 'last7days' ? '#e3f2fd' : 'white',
//                     cursor: 'pointer',
//                     fontSize: '12px',
//                     fontWeight:
//                       dateFilterType === 'last7days' ? 'bold' : 'normal'
//                   }}
//                 >
//                   Last 7 Days
//                 </button>
...
//                         : '1px solid #ccc',
//                     backgroundColor:
//                       dateFilterType === 'custom' ? '#e3f2fd' : 'white',
//                     cursor: 'pointer',
//                     fontSize: '12px',
...
//                     }}
//                   >
//                     🔍 Searching: "${searchQuery.substring(0, 30)}
...
//                       : dateFilterType.charAt(0).toUpperCase() +
//                         dateFilterType.slice(1)}
//                   </span>
//                 )}
//               </div>
//             </div>
...
//                   render: (_, itemvalue) => {
//                     const isSelected =
//                       activeData?.find((item) => item._id === itemvalue._id) !==
//                       undefined
...
//                           fontWeight: 'bold',
//                           textAlign: 'center',
//                           backgroundColor: isInsideValley
//                             ? '#e8f5e8'
//                             : '#fff3e0',
...
//                     const statusText =
//                       item?.ncmLastStatus ||
//                       (item?.isConfirmed ? 'Confirmed' : 'Pending Confirmation')
//                     return (
//                       <div
//                         style={{
//                           padding: '4px 8px',
...
//                             <button
//                               onClick={() =>
//                                 handleDeliveryPartnerUpdate(item._id)
//                               }
//                               disabled={isUpdating}
//                               style={{
//                                 padding: '2px 8px',
...
//                             borderRadius: '4px',
//                             fontSize: '11px',
//                             backgroundColor: deliveryPartner
//                               ? '#e3f2fd'
//                               : '#f5f5f5',
...
//                             onChange={(e) =>
//                               setNcmDestinationBranch(e.target.value)
//                             }
//                             style={{
//                               padding: '4px 8px',
//                               borderRadius: '4px',
...
//                               disabled={
//                                 updatingNcmBranchOrderId === item._id ||
...
//                     </div>
//                     <div style={{fontSize: '13px'}}>
//                       {modalOrder.phoneNumber ||
//                         modalOrder.userId?.phone ||
//                         '-'}
//                     </div>
//                   </div>
//                   <div>
...
//                     </div>
//                     <div style={{fontSize: '13px'}}>
//                       {modalOrder.shippingLocation ||
//                         modalOrder.locationAddress ||
//                         '-'}
//                     </div>
//                   </div>
...
//                           {formatDateTime(
//                             modalTracking?.ncm?.summary?.pickupCreatedAt ||
//                               modalOrder?.ncmPickupCreatedAt
//                           )}
//                         </div>
//                       </div>
//                       <div>
...
//                             fontSize: '13px',
//                             fontWeight: 600,
//                             color: modalTracking?.ncm?.summary?.pickupCompleted
//                               ? '#2e7d32'
//                               : '#f57c00'
//                           }}
//                         >
//                           {modalTracking?.ncm?.summary?.pickupCompleted
//                             ? 'Yes'
//                             : 'No'}
//                         </div>
//                       </div>
...
//                             fontSize: '13px',
//                             fontWeight: 600,
//                             color: modalTracking?.ncm?.summary?.delivered
//                               ? '#2e7d32'
//                               : '#f57c00'
//                           }}
//                         >
//                           {modalTracking?.ncm?.summary?.delivered
//                             ? 'Yes'
//                             : 'No'}
//                         </div>
//                       </div>
...
//                       }}
//                     >
//                       Latest Delivery Status Timeline
//                     </div>
//                     <div
//                       style={{
//                         display: 'flex',
...
//                       }}
//                     >
//                       {takeFirst(modalTracking?.ncm?.statuses, 10).map(
//                         (statusItem: any, index: number) => (
//                           <div
//                             key={index}
//                             style={{
...
//                         )
//                       )}
//                       {toSafeList(modalTracking?.ncm?.statuses).length ===
//                         0 && (
...
//                     >
//                       {takeFirst(modalTracking?.ncm?.comments, 8).map(
...
//                             <div style={{fontSize: '11px', color: '#777'}}>
//                               {commentItem?.addedBy || '-'} •{' '}
//                               {commentItem?.added_time || '-'}
//                             </div>
//                           </div>
//                         )
//                       )}
//                       {toSafeList(modalTracking?.ncm?.comments).length ===
//                         0 && (
//                         <div style={{fontSize: '12px', color: '#888'}}>
...
//                   }}
//                 >
//                   Products ({(modalOrder.products || []).length})
//                 </div>
//                 <div
//                   style={{
//                     display: 'flex',
...
//                                 .toString()
//                                 .trim()
//                                 .toLowerCase() === targetColor
//                           )
//                           const chosen = matched || images[0]
//                           const colored =
//                             (chosen as any)?.coloredImage ||
//                             (chosen as any)?.image ||
//                             null
//                           if (colored) {
...
//                       {getNprPrice(getTotalPrice(modalOrder.products || []))}
//                     </span>
//                   </div>
//                   <div
//                     style={{
...
//                     <span style={{fontWeight: 600}}>
//                       {getNprPrice(modalOrder.shippingPrice || 0)}
//                     </span>
//                   </div>
...
//                       <span style={{fontWeight: 600}}>
//                         {getNprPrice(modalOrder.giftBoxCharge)}
//                       </span>
//                     </div>
//                   )}
...
//                       </span>
//                       <span style={{fontWeight: 600}}>
//                         {getNprPrice(modalOrder.deliveryPartnerPrice)}
//                       </span>
//                     </div>
//                   )}
//                   <div
...
//                         {getNprPrice(modalOrder.totalAmount || 0)}
//                       </span>
//                     </div>
//                   </div>
//                 </div>
...
//           ?.map((item, index) => {
//             const {totalQuantity, totalPrice} = calculateOrderTotals(
//               item?.products || []
//             )
//             const locationQrData = generateLocationQrUrl(
//               item.latitude,
//               item.longitude
//             )
...
//                       Address by user:{item.shippingLocation}
//                     </Text>
//                     {item.locationAddress && (
//                       <Text style={styles.address}>
//                         Address From Map:{item.locationAddress}
//                       </Text>
//                     )}
...
//                     {truncateOrderNote(item?.orderNote)}
//                   </Text>
//                 </View>
...
//                         Rs. {item?.totalAmount?.toFixed(2) || 0}
//                       </Text>
//                     </View>
//                   </View>
...
//                           Rs.{' '}
//                           {(item?.totalAmount - item?.shippingPrice).toFixed(2)}
//                         </Text>
//                       </View>
//                     </View>
//                   )}
...
//         }}>
//           <HStack justify="space-between" style={{margin: '0'}}>
//             <div>
...
//                       padding: '8px 16px',
//                       borderRadius: '20px',
//                       border: dateFilterType === filter ? 'none' : '1px solid #d0d0d0',
//                       background: dateFilterType === filter 
//                         ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'
//                         : 'white',
//                       color: dateFilterType === filter ? 'white' : '#555',
//                       cursor: 'pointer',
//                       fontSize: '13px',
//                       fontWeight: dateFilterType === filter ? '600' : '500',
//                       transition: 'all 0.2s',
//                       boxShadow: dateFilterType === filter ? '0 2px 4px rgba(102,126,234,0.3)' : 'none'
//                     }}
//                   >
...
//                     📅 {dateFilterType === 'custom' && startDate && endDate
//                       ? `${new Date(startDate).toLocaleDateString()} - ${new Date(endDate).toLocaleDateString()}`
//                       : dateFilterType === 'last1hour' ? 'Last Hour' :
//                         dateFilterType === 'last7days' ? 'Last 7 Days' : 'All Orders'}
//                   </span>
//                 )}
//               </div>
//             </div>
...
//         {/* Card-based Order Display - No Horizontal Scroll */}
//         {!showDetails && (
//           <div>
//             {loading ? (
//               <div style={{
...
//                     borderRadius: '8px',
//                     border: '1px solid #d0d0d0',
//                     backgroundColor: page * limit >= totalOrders ? '#f5f5f5' : 'white',
//                     color: page * limit >= totalOrders ? '#ccc' : '#667eea',
...
//             zIndex: 100
//           }}>
//             {activeData.filter(item => Object.keys(item).length !== 0).length > 0 && (
//               <button
//                 onClick={() => {
...
//           >
//             {isSelected ? (
//               <IoCheckboxOutline size={24} color="#667eea" />
//             ) : (
//               <MdCheckBoxOutlineBlank size={24} color="#bbb" />
//             )}
//           </div>
//           <div>
//             <div style={{
...
//             }}
//           >
//             <Trash2 size={16} /> {deletingOrderId === order._id ? 'Deleting...' : 'Delete'}
//           </button>
//         </div>
//       </div>
...
//             </div>
//           </div>
//           <div style={{maxHeight: expandedProducts ? 'none' : '100px', overflow: 'hidden'}}>
//             {order.products?.slice(0, expandedProducts ? undefined : 2).map((product, idx) => (
//               <div key={idx} style={{
//                 fontSize: '12px',
//                 padding: '4px 0',
//                 borderBottom: idx < (expandedProducts ? order.products.length - 1 : 1) ? '1px solid #e0e0e0' : 'none'
//               }}>
//                 <span style={{fontWeight: '500'}}>{truncateText(product.productId?.name, 25)}</span>
//                 <span style={{color: '#666', marginLeft: '8px'}}>x{product.quantity}</span>
//                 <span style={{float: 'right', color: '#28a745', fontWeight: '500'}}>
//                   {getNprPrice(product.price)}
//                 </span>
//               </div>
//             ))}
//           </div>
...
//               }}
//             >
//               {expandedProducts ? 'Show Less' : `Show ${order.products.length - 2} More`}
//             </button>
//           )}
//         </div>
...
//             📍 {truncateText(order.shippingLocation || order.locationAddress, 40)}
//           </div>
...
//               fontSize: '11px',
//               fontWeight: '500',
//               backgroundColor: order.isInsideValley ? '#d4edda' : '#fff3e0',
//               color: order.isInsideValley ? '#155724' : '#f57c00'
//             }}>
...
//         {/* Delivery Partner */}
//         <div>
//           <div style={{fontSize: '11px', color: '#888', textTransform: 'uppercase', fontWeight: '600', marginBottom: '8px'}}>
//             Delivery Partner
//           </div>
...
//               <div style={{display: 'flex', gap: '8px'}}>
//                 <button
//                   onClick={() => handleDeliveryPartnerUpdate(order._id)}
//                   disabled={isUpdating}
//                   style={{
//                     flex: 1,
//                     padding: '6px',
...
//                 fontSize: '13px',
//                 fontWeight: '500',
//                 backgroundColor: order.deliveryPartner ? '#e3f2fd' : '#f0f0f0',
//                 color: order.deliveryPartner ? '#1976d2' : '#999'
//               }}>
//                 {order.deliveryPartner || 'Not Set'}
//               </span>
//               <button
//                 onClick={() => startEditingDeliveryPartner(order)}
//                 style={{
//                   padding: '4px 8px',
//                   borderRadius: '6px',
//                   border: '1px solid #667eea',
...
//               <div style={{display: 'flex', gap: '8px'}}>
//                 <button
//                   onClick={() => handleNcmBranchUpdate(order._id)}
//                   disabled={updatingNcmBranchOrderId === order._id}
//                   style={{
//                     flex: 1,
//                     padding: '6px',
//                     borderRadius: '6px',
...
//                 fontSize: '13px',
//                 fontWeight: '500',
//                 backgroundColor: order.ncmDestinationBranch ? '#d4edda' : '#f0f0f0',
//                 color: order.ncmDestinationBranch ? '#155724' : '#999'
//               }}>
//                 {order.ncmDestinationBranch || 'Global Default'}
//               </span>
//               <button
//                 onClick={() => startEditingNcmBranch(order)}
//                 style={{
//                   padding: '4px 8px',
//                   borderRadius: '6px',
//                   border: '1px solid #28a745',
...
//               fontSize: '13px',
//               fontWeight: '500',
//               backgroundColor: order.isConfirmed ? '#d4edda' : '#fff3e0',
//               color: order.isConfirmed ? '#155724' : '#f57c00'
//             }}>
...
//                   background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
//                   color: 'white',
//                   cursor: confirmingOrderId === order._id ? 'not-allowed' : 'pointer',
//                   fontSize: '12px',
//                   fontWeight: '500'
//                 }}
//               >
...
//       }}>
//         <div>
//           <div style={{fontSize: '11px', color: '#888', marginBottom: '4px'}}>Subtotal</div>
//           <div style={{fontSize: '16px', fontWeight: '600', color: '#333'}}>
//             {getNprPrice(getTotalPrice(order.products || []))}
//           </div>
//         </div>
//         <div>
//           <div style={{fontSize: '11px', color: '#888', marginBottom: '4px'}}>Shipping</div>
//           <div style={{fontSize: '14px', fontWeight: '500', color: '#666'}}>
//             {getNprPrice(order.shippingPrice || 0)}
//           </div>
//         </div>
//         <div>
//           <div style={{fontSize: '11px', color: '#888', marginBottom: '4px'}}>Total Amount</div>
//           <div style={{fontSize: '20px', fontWeight: '700', color: '#28a745'}}>
//             {getNprPrice(order.totalAmount || 0)}
//           </div>
//         </div>
//       </div>
