...
//           // defaultImage may be an array of strings (urls or filenames)
//           // or an array containing a variant object with coloredImages
//           const urls: string[] = []

//           defaultImage.forEach((item: any) => {
//             if (!item) return
//             if (typeof item === 'string') {
//               urls.push(item)
//             } else if (Array.isArray(item.coloredImages)) {
//               urls.push(...item.coloredImages)
//             } else if (typeof item.coloredImage === 'string') {
//               urls.push(item.coloredImage)
//             }
//           })

//           const remappedFiles = urls.map((u: string) => {
//             let fileUrl = u
//             // if filename (not full url), build proper URL
//             if (!u.startsWith('http') && !u.startsWith('/')) {
//               if (isBanner) fileUrl = `${FILE_URL}/banners/${u}`
//               else if (uniqueKeys === 'testimonialImages') fileUrl = `${FILE_URL}/testimonial/${u}`
//               else fileUrl = `${FILE_URL}/products/${u}`
//             }
//             return {
//               file: fileUrl,
//               isNew: false,
//               id: u, // use filename or url as identifier so deletes reference it
//             }
//           })
